 ...
 *
 * When you build the Activity that initiates a download and tracks the progress
 * by implementing the {@link IDownloadCallback} interface, you'll receive a
 * DownloadProgressInfo object in each call to the
 * {@link IDownloadCallback#onDownloadProgress} method. This allows you to
 * update your activity's UI with information about the download progress, such
 * as the progress so far, time remaining and current speed.
 */
public class DownloadProgressInfo implements Parcelable {
	public long mOverallTotal = 1;

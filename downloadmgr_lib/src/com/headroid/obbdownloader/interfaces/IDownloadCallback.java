...
public interface IDownloadCallback {
	...
	static final int STATE_OBB_ALREADY_EXIST = 20;

	static final int STATE_FAILED_CONNECTION_TIMEOUT = 21;
	
	static final int STATE_STORAGE_SPACE_NOT_ENOUGHT = 22;
	
	static final int STATE_ERROR_HTTP_DATA_ERROR = 23;
	

	static final int STATE_CELLULAR_DOWNLOADING = 24;
	

	static final int STATE_STORAGE_UNMOUNTED = 25;
	/**
	 ...
	 * 
	 * @param m
	 *            the service Messenger. This Messenger is used to call the
...
//	void onServiceConnected(Messenger m);
	 ...
	 * 
	 * @param newState
	 *            one of the STATE_* values defined in IDownloaderClient
	 */
	 ...
	 * 
	 * @param progress
	 *            the DownloadProgressInfo object containing the current
